...
local function cimgui_generation(parser,name)
    ...
    --merge it in cimgui_internal_template.cpp to cimgui_markdown.cpp
...
-----------------------------do it----------------------
--------------------------------------------------------
--get imgui_markdown.h version--------------------------
local pipe,err = io.open("../imgui_markdown/imgui_markdown.h","r")
if not pipe then
    error("could not open file:"..err)
end
--local imgui_markdown_version
--while true do
    --local line = pipe:read"*l"
    --imgui_markdown_version = line:match([[ImPlot%s+v(.+)]])
    --if imgui_markdown_version then break end
--end
pipe:close()
--cimgui_header = cimgui_header:gsub("XXX",imgui_markdown_version)
--print("IMPLOT_VERSION",imgui_markdown_version)
...
-------------funtion for parsing imgui_markdown headers
...
local modulename = "cimmarkdown"
local headers = [[#include "../imgui_markdown/imgui_markdown.h" 
]]
local headersT = {[[imgui_markdown]]}
if INTERNAL_GENERATION then
