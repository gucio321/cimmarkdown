...
CIMGUI_API void igdefaultMarkdownTooltipCallback(MarkdownTooltipCallbackData data_);
CIMGUI_API typedef MarkdownImageData igMarkdownImageCallback(MarkdownLinkCallbackData data);
CIMGUI_API typedef void igMarkdownFormalCallback(const MarkdownFormatInfo markdownFormatInfo_,bool start_);
CIMGUI_API void igdefaultMarkdownFormatCallback_Nil(const MarkdownFormatInfo markdownFormatInfo_,bool start_);
CIMGUI_API void igMarkdown_Nil(const char* markdown_,size_t markdownLength_,const MarkdownConfig mdConfig_);
CIMGUI_API void igUnderLine_Nil(ImColor col_);
CIMGUI_API void igRenderLine_Nil(const char* markdown_,Line* line_,TextRegion* textRegion_,const MarkdownConfig mdConfig_);
CIMGUI_API TextRegion* TextRegion_TextRegion(void);
CIMGUI_API void TextRegion_destroy(TextRegion* self);
CIMGUI_API void TextRegion_RenderTextWrapped(TextRegion* self,const char* text_,const char* text_end_,bool bIndentToHere_);
CIMGUI_API void TextRegion_RenderListTextWrapped(TextRegion* self,const char* text_,const char* text_end_);
CIMGUI_API bool TextRegion_RenderLinkText(TextRegion* self,const char* text_,const char* text_end_,const Link link_,const char* markdown_,const MarkdownConfig mdConfig_,const char** linkHoverStart_);
CIMGUI_API void TextRegion_RenderLinkTextWrapped(TextRegion* self,const char* text_,const char* text_end_,const Link link_,const char* markdown_,const MarkdownConfig mdConfig_,const char** linkHoverStart_,bool bIndentToHere_);
CIMGUI_API void TextRegion_ResetIndent(TextRegion* self);
CIMGUI_API int TextBlock_size(TextBlock* self);
CIMGUI_API void igUnderLine_Nil(ImColor col_);
CIMGUI_API void igRenderLine_Nil(const char* markdown_,Line* line_,TextRegion* textRegion_,const MarkdownConfig mdConfig_);
CIMGUI_API void igMarkdown_Nil(const char* markdown_,size_t markdownLength_,const MarkdownConfig mdConfig_);
CIMGUI_API bool igIsCharInsideWord(char c_);
CIMGUI_API void igdefaultMarkdownFormatCallback_Nil(const MarkdownFormatInfo markdownFormatInfo_,bool start_);
